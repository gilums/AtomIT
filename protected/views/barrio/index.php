<div class="contenedor-titulo">
    ...
    <div class="text-right">
        ...
        <a href="<?php echo Yii::app()->createAbsoluteUrl('barrio/create'); ?>" class="btn btn-default btn-link-c"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a>
    </div>
</div>
<div class="contenedor-cont-vistas">
    <div class="panel panel-default">
        <div class="panel-heading text-left"><span class="color-txt">Administrador Barrio</span> <!--<a href="#" class="btn-link btn-sm search-button"><i class="fa fa-search"></i></a><a href="<?php #echo Yii::app()->createAbsoluteUrl('barrio/create'); ?>" class="btn-link btn-sm"><i class="fa fa-plus"></i></a>--></div>
